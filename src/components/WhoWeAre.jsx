const WhoWeAre = () => {
  return (
    <section className="bg-dark-gray px-4 md:px-[100px] py-10 text-light-gray">
      <div className="container mx-auto  grid grid-cols-[1.5fr_1fr_1fr] gap-10">
        {/* Column 1 */}
        <div className="space-y-4 col-span-1 ">
          <h2 className="text-[30px] text-golden-brown font-[500]">
            Who We Are
          </h2>
          <div className="text-[50px] font-[500] w-[500px] ">
            The Heart of Every Production We Made
          </div>
          <p className="font-[500] w-[400px] ">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex space-y-5 pt-14 flex-col">
